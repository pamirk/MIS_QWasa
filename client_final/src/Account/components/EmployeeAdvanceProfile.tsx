...
import styles from './EAPstyle.less';
...
class PAGE_NAME_UPPER_CAMEL_CASE extends Component<{ loading: boolean; BLOCK_NAME_CAMEL_CASE: AdvancedProfileData; dispatch: Dispatch<any> },
